...
public class EncryptDES3 {
	...
	public EncryptDES3() throws NoSuchAlgorithmException, NoSuchPaddingException {
		// 实例化支持DES算法的密钥生成器(算法名称命名需按规定，否则抛出异常)
		keygen = KeyGenerator.getInstance("DESede", new org.bouncycastle.jce.provider.BouncyCastleProvider());
		// 生成密钥

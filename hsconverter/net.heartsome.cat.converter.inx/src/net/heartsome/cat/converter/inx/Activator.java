...
public class Activator implements BundleActivator {
	...
	public static final String PLUGIN_ID = "net.heartsome.cat.converter.inx";
	...
	private class XmlPositiveCustomizer implements ServiceTrackerCustomizer {
		...
		public Object addingService(ServiceReference reference) {
			...
			Converter inx2Xliff = new Inx2Xliff(converter);
			Properties properties = new Properties();
			properties.put(Converter.ATTR_NAME, Inx2Xliff.NAME_VALUE);
			properties.put(Converter.ATTR_TYPE, Inx2Xliff.TYPE_VALUE);
			properties.put(Converter.ATTR_TYPE_NAME, Inx2Xliff.TYPE_NAME_VALUE);
	...
	private class XmlReverseCustomize implements ServiceTrackerCustomizer {
		...
		public Object addingService(ServiceReference reference) {
			Converter converter = (Converter) bundleContext.getService(reference);
			Converter xliff2Inx = new Xliff2Inx(converter);
			Properties properties = new Properties();
			properties.put(Converter.ATTR_NAME, Xliff2Inx.NAME_VALUE);
			properties.put(Converter.ATTR_TYPE, Xliff2Inx.TYPE_VALUE);
			properties.put(Converter.ATTR_TYPE_NAME, Xliff2Inx.TYPE_NAME_VALUE);

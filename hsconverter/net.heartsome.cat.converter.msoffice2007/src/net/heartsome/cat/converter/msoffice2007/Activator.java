...
public class Activator implements BundleActivator {
	...
	public static final String PLUGIN_ID = "net.heartsome.cat.converter.msoffice2007";
	...
	private class XmlReverseCustomize implements ServiceTrackerCustomizer {
		...
		public Object addingService(ServiceReference reference) {
			...
			Converter xliff2MSOffice = new Xliff2MSOffice(converter);
			Properties properties = new Properties();
			...
			ServiceRegistration registration = ConverterRegister.registerReverseConverter(bundleContext,
					xliff2MSOffice, properties);
			return registration;
		}

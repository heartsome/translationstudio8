...
public class FooterPart extends PartOperate {
	 ...
	 * @throws Exception
	 */
	public FooterPart(String partPath, XliffOutputer xlfOutput, StringSegmenter segmenter) throws Exception {
	 ...
	 * @param xlfInput
	 */
	public FooterPart (String partPath, XliffInputer xlfInput) throws Exception {
	...
	protected void converter() throws Exception {
		operateTransAttributes("/w:ftr/descendant::w:p/w:r/w:pict/v:shape/@alt");
		
		// 处理的单元为 w:p
		String xpath = "/w:ftr/descendant::w:p";
...
// ------------------------------------------  下面是逆转换的代码 ------------------------------------------------
	...
	protected void reverseConvert() throws Exception {
		...
		//再处理可翻译属性
		xpath = "/w:ftr/descendant::w:p/w:r/w:pict/v:shape/@alt";

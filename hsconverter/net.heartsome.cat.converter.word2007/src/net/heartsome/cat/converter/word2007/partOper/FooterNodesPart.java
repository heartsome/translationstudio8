...
/**
 * 脚注的处理类，针对于 footerNodes.xml 文件
 * @author robert	2012-08-16
 */
public class FooterNodesPart extends PartOperate {
	 ...
	 * @throws Exception
	 */
	public FooterNodesPart(String partPath, XliffOutputer xlfOutput, StringSegmenter segmenter) throws Exception {
	 ...
	 * @param xlfInput
	 */
	public FooterNodesPart (String partPath, XliffInputer xlfInput) throws Exception {
	...
	protected void converter() throws Exception {
		operateTransAttributes("/w:footnotes/w:footnote/descendant::w:p/w:r/w:pict/v:shape/@alt");
	}
	 ...
	 * @throws Exception
	 */
	protected void operateFooterNodesContent(String id) throws Exception {
		
		// 处理的单元为 w:p
		String xpath = "/w:footnotes/w:footnote[@w:id='" + id + "']/descendant::w:p";
...
// ------------------------------------------  下面是逆转换的代码 ------------------------------------------------
	...
	protected void reverseConvert() throws Exception {
		// 处理的单元为 w:p
		String xpath = "/w:footnotes/w:footnote/descendant::w:p";
		ap.selectXPath(xpath);
		while(ap.evalXPath() != -1){
			// DOLATER 先处理所有的属性
		...
		//再处理可翻译属性
		xpath = "/w:footnotes/w:footnote/descendant::w:p/w:r/w:pict/v:shape/@alt";

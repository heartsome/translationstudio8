...
public class ReverseConversionWizard extends Wizard {
	...
	public ReverseConversionWizard(List<ConverterViewModel> models, IProject projct) {
		...
		setWindowTitle(Messages.getString("ReverseConversionWizard.0")); //$NON-NLS-1$
	...
	public void addPages() {
		addPage(new ReverseConversionWizardPage(Messages.getString("ReverseConversionWizard.1")));
		// TODO 存储翻译到翻译记译库
	}

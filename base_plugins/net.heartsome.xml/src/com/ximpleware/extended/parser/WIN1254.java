...
/**
 * this class contains method to map a windows-1254 char
 * into a Unicode char
 * 
 */
public class WIN1254 {
    ...
    static {
        ...
        chars[0xD0 ]=0x011E  ;// LATIN CAPITAL LETTER G WITH BREVE
        ...
        chars[0xDD ]=0x0130  ;// LATIN CAPITAL LETTER I WITH DOT ABOVE
        chars[0xDE ]=0x015E  ;// LATIN CAPITAL LETTER S WITH CEDILLA
        ...
        chars[0xF0 ]=0x011F  ;// LATIN SMALL LETTER G WITH BREVE
        ...
        chars[0xFD ]=0x0131  ;// LATIN SMALL LETTER DOTLESS I
        chars[0xFE ]=0x015F  ;// LATIN SMALL LETTER S WITH CEDILLA

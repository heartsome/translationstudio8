...
/**
 * this class contains method to map a windows-1250 char
 * into a Unicode char
 * 
 */
public class WIN1250 {
    ...
    static {
        ...
        chars[0x8C ]=0x015A  ;// LATIN CAPITAL LETTER S WITH ACUTE
        chars[0x8D ]=0x0164  ;// LATIN CAPITAL LETTER T WITH CARON
        chars[0x8E ]=0x017D  ;// LATIN CAPITAL LETTER Z WITH CARON
        chars[0x8F ]=0x0179  ;// LATIN CAPITAL LETTER Z WITH ACUTE
        ...
        chars[0x9C ]=0x015B  ;// LATIN SMALL LETTER S WITH ACUTE
        chars[0x9D ]=0x0165  ;// LATIN SMALL LETTER T WITH CARON
        chars[0x9E ]=0x017E  ;// LATIN SMALL LETTER Z WITH CARON
        chars[0x9F ]=0x017A  ;// LATIN SMALL LETTER Z WITH ACUTE
        chars[0xA0 ]=0x00A0  ;// NO-BREAK SPACE
        chars[0xA1 ]=0x02C7  ;// CARON
        chars[0xA2 ]=0x02D8  ;// BREVE
        chars[0xA3 ]=0x0141  ;// LATIN CAPITAL LETTER L WITH STROKE
        chars[0xA4 ]=0x00A4  ;// CURRENCY SIGN
        chars[0xA5 ]=0x0104  ;// LATIN CAPITAL LETTER A WITH OGONEK
        ...
        chars[0xB9 ]=0x0105  ;// LATIN SMALL LETTER A WITH OGONEK
        chars[0xBA ]=0x015F  ;// LATIN SMALL LETTER S WITH CEDILLA
        chars[0xBB ]=0x00BB  ;// RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
        chars[0xBC ]=0x013D  ;// LATIN CAPITAL LETTER L WITH CARON
        chars[0xBD ]=0x02DD  ;// DOUBLE ACUTE ACCENT
        chars[0xBE ]=0x013E  ;// LATIN SMALL LETTER L WITH CARON

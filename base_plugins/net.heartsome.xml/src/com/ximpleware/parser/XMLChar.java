...
public class XMLChar {
    ...
    static {
        ...
        int xmlCharRange[][] = { { 0x0009, 0x000A }, {
                0x000D, 0x000D }, {
                0x0020, 0xD7FF }, {
                0xE000, 0xFFFD }, };
        ...
        int xmlSpaceChar[] = { 0x0020, 0x0009, 0x000D, 0x000A, };
        ...
        int xmlNameChar[] = { 0x002D, 0x002E, // '-' and '.'
        };
        ...
        int xmlNameStartChar[] = { 0x003A, 0x005F, // ':' and '_'
        };
        ...
        int xmlPubidChar[] =
            { 0x000A, 0x000D, 0x0020, 0x0021, 0x0023, 0x0024, 0x0025, 0x003D, 0x005F };

        int xmlPubidRange[][] = { { 0x0027, 0x003B }, {
                0x003F, 0x005A }, {
                0x0061, 0x007A }
        };
		...
		// BaseChar
				...
				{ 0x00D8, 0x00F6 }, { 0x00F8, 0x0131 }, { 0x0134, 0x013E },
				{ 0x0141, 0x0148 }, { 0x014A, 0x017E }, { 0x0180, 0x01C3 },
				{ 0x01CD, 0x01F0 }, { 0x01F4, 0x01F5 }, { 0x01FA, 0x0217 },
				{ 0x0250, 0x02A8 }, { 0x02BB, 0x02C1 }, { 0x0388, 0x038A },
				...
				{ 0x0561, 0x0586 }, { 0x05D0, 0x05EA }, { 0x05F0, 0x05F2 },
				{ 0x0621, 0x063A }, { 0x0641, 0x064A }, { 0x0671, 0x06B7 },
				{ 0x06BA, 0x06BE }, { 0x06C0, 0x06CE }, { 0x06D0, 0x06D3 },
				{ 0x06E5, 0x06E6 }, { 0x0905, 0x0939 }, { 0x0958, 0x0961 },
				{ 0x0985, 0x098C }, { 0x098F, 0x0990 }, { 0x0993, 0x09A8 },
				{ 0x09AA, 0x09B0 }, { 0x09B6, 0x09B9 }, { 0x09DC, 0x09DD },
				...
				{ 0x0A59, 0x0A5C }, { 0x0A72, 0x0A74 }, { 0x0A85, 0x0A8B },
				{ 0x0A8F, 0x0A91 }, { 0x0A93, 0x0AA8 }, { 0x0AAA, 0x0AB0 },
				{ 0x0AB2, 0x0AB3 }, { 0x0AB5, 0x0AB9 }, { 0x0B05, 0x0B0C },
				{ 0x0B0F, 0x0B10 }, { 0x0B13, 0x0B28 }, { 0x0B2A, 0x0B30 },
				{ 0x0B32, 0x0B33 }, { 0x0B36, 0x0B39 }, { 0x0B5C, 0x0B5D },
				{ 0x0B5F, 0x0B61 }, { 0x0B85, 0x0B8A }, { 0x0B8E, 0x0B90 },
				{ 0x0B92, 0x0B95 }, { 0x0B99, 0x0B9A }, { 0x0B9E, 0x0B9F },
				...
				{ 0x0E01, 0x0E2E }, { 0x0E32, 0x0E33 }, { 0x0E40, 0x0E45 },
				{ 0x0E81, 0x0E82 }, { 0x0E87, 0x0E88 }, { 0x0E94, 0x0E97 },
				{ 0x0E99, 0x0E9F }, { 0x0EA1, 0x0EA3 }, { 0x0EAA, 0x0EAB },
				{ 0x0EAD, 0x0EAE }, { 0x0EB2, 0x0EB3 }, { 0x0EC0, 0x0EC4 },
				{ 0x0F40, 0x0F47 }, { 0x0F49, 0x0F69 }, { 0x10A0, 0x10C5 },
				{ 0x10D0, 0x10F6 }, { 0x1102, 0x1103 }, { 0x1105, 0x1107 },
				{ 0x110B, 0x110C }, { 0x110E, 0x1112 }, { 0x1154, 0x1155 },
				{ 0x115F, 0x1161 }, { 0x116D, 0x116E }, { 0x1172, 0x1173 },
				{ 0x11AE, 0x11AF }, { 0x11B7, 0x11B8 }, { 0x11BC, 0x11C2 },
				{ 0x1E00, 0x1E9B }, { 0x1EA0, 0x1EF9 }, { 0x1F00, 0x1F15 },
				{ 0x1F18, 0x1F1D }, { 0x1F20, 0x1F45 }, { 0x1F48, 0x1F4D },
				{ 0x1F50, 0x1F57 }, { 0x1F5F, 0x1F7D }, { 0x1F80, 0x1FB4 },
				{ 0x1FB6, 0x1FBC }, { 0x1FC2, 0x1FC4 }, { 0x1FC6, 0x1FCC },
				{ 0x1FD0, 0x1FD3 }, { 0x1FD6, 0x1FDB }, { 0x1FE0, 0x1FEC },
				{ 0x1FF2, 0x1FF4 }, { 0x1FF6, 0x1FFC }, { 0x212A, 0x212B },
		...
		int xmlCombiningCharRange[][] = { { 0x0300, 0x0345 },
				{ 0x0360, 0x0361 }, { 0x0483, 0x0486 }, { 0x0591, 0x05A1 },
				{ 0x05A3, 0x05B9 }, { 0x05BB, 0x05BD }, { 0x05C1, 0x05C2 },
				{ 0x064B, 0x0652 }, { 0x06D6, 0x06DC }, { 0x06DD, 0x06DF },
				{ 0x06E0, 0x06E4 }, { 0x06E7, 0x06E8 }, { 0x06EA, 0x06ED },
				{ 0x0901, 0x0903 }, { 0x093E, 0x094C }, { 0x0951, 0x0954 },
				{ 0x0962, 0x0963 }, { 0x0981, 0x0983 }, { 0x09C0, 0x09C4 },
				{ 0x09C7, 0x09C8 }, { 0x09CB, 0x09CD }, { 0x09E2, 0x09E3 },
				{ 0x0A40, 0x0A42 }, { 0x0A47, 0x0A48 }, { 0x0A4B, 0x0A4D },
				{ 0x0A70, 0x0A71 }, { 0x0A81, 0x0A83 }, { 0x0ABE, 0x0AC5 },
				{ 0x0AC7, 0x0AC9 }, { 0x0ACB, 0x0ACD }, { 0x0B01, 0x0B03 },
				{ 0x0B3E, 0x0B43 }, { 0x0B47, 0x0B48 }, { 0x0B4B, 0x0B4D },
				{ 0x0B56, 0x0B57 }, { 0x0B82, 0x0B83 }, { 0x0BBE, 0x0BC2 },
				{ 0x0BC6, 0x0BC8 }, { 0x0BCA, 0x0BCD }, { 0x0C01, 0x0C03 },
				...
				{ 0x0D4A, 0x0D4D }, { 0x0E34, 0x0E3A }, { 0x0E47, 0x0E4E },
				{ 0x0EB4, 0x0EB9 }, { 0x0EBB, 0x0EBC }, { 0x0EC8, 0x0ECD },
				{ 0x0F18, 0x0F19 }, { 0x0F71, 0x0F84 }, { 0x0F86, 0x0F8B },
				{ 0x0F90, 0x0F95 }, { 0x0F99, 0x0FAD }, { 0x0FB1, 0x0FB7 },
				{ 0x20D0, 0x20DC }, { 0x302A, 0x302F }, };

		int xmlCombiningCharChar[] = { 0x05BF, 0x05C4, 0x0670, 0x093C, 0x094D,
				0x09BC, 0x09BE, 0x09BF, 0x09D7, 0x0A02, 0x0A3C, 0x0A3E, 0x0A3F,
				0x0ABC, 0x0B3C, 0x0BD7, 0x0D57, 0x0E31, 0x0EB1, 0x0F35, 0x0F37,
				0x0F39, 0x0F3E, 0x0F3F, 0x0F97, 0x0FB9, 0x20E1, 0x3099, 0x309A, };

		//
		// [88] Digit ::= ...
		//

		int xmlDigitRange[][] = { { 0x0030, 0x0039 }, { 0x0660, 0x0669 },
				{ 0x06F0, 0x06F9 }, { 0x0966, 0x096F }, { 0x09E6, 0x09EF },
        ...
        int xmlExtenderRange[][] = { { 0x3031, 0x3035 }, {
                0x309D, 0x309E }, {
                0x30FC, 0x30FE }, };
        ...
        for (int i = 0; i < xmlSpecialChar.length; i++) {
            UNI_CHARS[xmlSpecialChar[i]] =
                (byte) (UNI_CHARS[xmlSpecialChar[i]] & ~XML_CONTENT);
        }
        ...
        for (int i = 0; i < xmlNameStartChar.length; i++) {
            UNI_CHARS[xmlNameStartChar[i]] |= XML_NAME_START
                | XML_NAME
                | XML_NCNAME_START
                | XML_NCNAME;
        }
        ...
        for (int i = 0; i < xmlLetterChar.length; i++) {
            UNI_CHARS[xmlLetterChar[i]] |= XML_NAME_START
                | XML_NAME
                | XML_NCNAME_START
                | XML_NCNAME;
        }
        ...
        for (int i = 0; i < xmlCombiningCharRange.length; i++) {
            for (int j = xmlCombiningCharRange[i][0];
                j <= xmlCombiningCharRange[i][1];
                j++) {
                UNI_CHARS[j] |= XML_NAME | XML_NCNAME;
            }
        }
    ...
    public static boolean isContentChar(int c) {
        return (c < 0x10000 && (UNI_CHARS[c] & XML_CONTENT) != 0) ||
    ...
    public static boolean isNmtoken(String nmToken) {
        ...
        for (int i = 0; i < nmToken.length(); i++ )
           if(!isNameChar( nmToken.charAt(i))) return false;
    ...
    public static boolean isValidChar(int c) {
        return (c < 0x10000 && (UNI_CHARS[c] & XML_VALID) != 0) ||
               (0x10000 <= c && c <= 0x10FFFF);
    }
    /**
     * Returns the low surrogate from a Unicode scalar value
     *
     * @param c The Unicode scalar value to "split".
     */
     ...
     * surrogates.
     *
     * @param hi The high surrogate.
     * @param lo The low surrogate.
     */

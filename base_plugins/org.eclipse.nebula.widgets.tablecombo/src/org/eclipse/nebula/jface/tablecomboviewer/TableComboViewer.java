...
/**
 * TableComboViewerRow is basically identical to the TableViewer class with a few modifications to reference the Table
 * within the TableCombo widget instead of a parent Table widget.
 */

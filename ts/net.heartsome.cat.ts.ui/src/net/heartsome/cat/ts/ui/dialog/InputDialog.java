...
/**
 * A simple input dialog for soliciting an input string from the user.<Br/>
 * 此类与 org.eclipse.jface.dialogs.InputDialog 的区别为使用此类时错误提示信息超过对话框宽度会自动换行并调整窗口高度。
 * <p>
...
public class InputDialog extends Dialog {
	...
	protected Point getInitialLocation(Point initialSize) {
		initLocation = super.getInitialLocation(initialSize);
		return initLocation;
	}

	@Override
	protected Point getInitialSize() {
		initSize = super.getInitialSize();
		return initSize;
	}
}

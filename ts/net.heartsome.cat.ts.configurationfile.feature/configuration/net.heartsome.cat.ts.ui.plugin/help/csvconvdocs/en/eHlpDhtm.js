...
//{{HH_SYMBOL_SECTION
var HH_ChmFilename = "C:\\Project\\target\\csvconvdocs\\en\\CSV to TMX Converter.chm";
...
{
	if( !CCSSP.bIsWinOS && !CCSSP.bIsSunOS && !(CCSSP.bIsMacOS&&CCSSP.bIsIE5))
		return 0;
...
{
	if( (!gbBsIE4) || (!CCSSP.bIsWinOS && !CCSSP.bIsSunOS && !(CCSSP.bIsMacOS&&CCSSP.bIsIE5)))
		return;
...
{
	if( (!CCSSP.bIsWinOS && !CCSSP.bIsSunOS  && !(CCSSP.bIsMacOS&&CCSSP.bIsIE5)) || typeof(target_ID) != "string" )//MUST have a target_ID
...
{ // to add the "funcHandler" as the "rawEventName" 's handler to the "srcObj" object,the original event handler will be combined
	...
	if (CCSSP.bIsMacOS &&CCSSP.bIsIE4&&!CCSSP.bIsIE5)
	{
